...
#todo write this file in a way that logic_handler only uses this file,
# and does not directly uses other files of this directory
...
def get_NS(graph):
    return var_metrics.average_NS(graph)
