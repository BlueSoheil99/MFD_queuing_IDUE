...
parameter
         m(i,d) 'vehicle numbers without queue length in region i with destination d',
...
$GDXIN MtoG2
$LOAD m q v demand MFD_Para u

MFD_Para(j, 'm3')$(sum(d2, m(j,d2))>10000)=0;
MFD_Para(j, 'm2')$(sum(d2, m(j,d2))>10000)=0;
MFD_Para(j, 'm1')$(sum(d2, m(j,d2))>10000)=0;
MFD_Para(j, 'm0')$(sum(d2, m(j,d2))>10000)=4256;
