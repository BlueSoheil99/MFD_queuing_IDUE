...
net_fname, info_fname, option, net_edges_fname, interval_begin, interval_end = util.init_config(input_addresses)
...
net, edges = util.read_network(net_fname, net_edges_fname)
