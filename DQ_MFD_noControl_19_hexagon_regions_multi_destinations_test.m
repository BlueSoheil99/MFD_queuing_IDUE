...
qU_all_out = [];
qU_data_all =[];
qU_data_all(1:size(region_communi,1),:) = 0;
qD_all_out = [];
qD_data_all =[];
qD_data_all(1:size(region_communi,1),:) = 0;
p_trans = zeros(19,19,19);
qD_out = zeros(19,19,19);
pTilda_region_in = zeros(1,num_reg);
...
for t=1:T:T*7200
    ...
    wgdx('MtoG2', n, qU, qD, v, demand, MFD_Para);
